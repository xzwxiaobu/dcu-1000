...
typedef struct
{
    ...
    int8u   __bPSLRelay_K12_Coil        : 1;    //4.6   线圈电压  PSL-k12
    int8u   __bPSLRelay_K12_Fault       : 1;    //4.7   故障位
...
typedef struct
{
    ...
    int8u   bPedc_TrainState            : 1;    //0.4  列车状态信号
    ...
    //BYTE 3
    int8u   __bPedcPSL3_EN              : 1;    //3.0  SL3操作允许
    int8u   __bPedcPSL3_CLS             : 1;    //3.1  SL3关门
    int8u   __bPedcPSL3_OPN6            : 1;    //3.2  SL3开6车
    int8u   __bPedcPSL3_OPN8            : 1;    //3.3  SL3开8车
    int8u   __bPedcPSL3_BYPASS          : 1;    //3.4  SL3互锁解除
    int8u                               : 1;    //3.5
    int8u                               : 1;    //3.6
    int8u                               : 1;    //3.7
    ...
    //BYTE 6
    int8u   bPedcPSC_IBPPSL_OPN1        : 1;    //6.0  IBP/PSL开门
    int8u   bPedcPSC_OpnSide            : 1;    //6.1  PSC 开边门检测
    int8u                               : 1;    //6.2
    int8u                               : 1;    //6.3
    int8u                               : 1;    //6.4
    int8u                               : 1;    //6.5
    ...
    //BYTE 9      /* 风阀 */
    int8u   bBASOpnCmd                  : 1;    //9.0   BAS开阀命令
    int8u   bBASClsCmd                  : 1;    //9.1   BAS关阀命令
    int8u   bMMSOpnCmd                  : 1;    //9.2   MMS开阀命令
    int8u   bMMSClsCmd                  : 1;    //9.3   MMS关阀命令
    int8u                               : 1;    //9.4
    int8u                               : 1;    //9.5
    int8u                               : 1;    //9.6
    int8u   bBASOffLine                 : 1;    //9.7   BAS通讯离线
